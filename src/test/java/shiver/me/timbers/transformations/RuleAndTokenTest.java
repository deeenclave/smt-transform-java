...
import static shiver.me.timbers.TestData.RULE_TRANSFORMATION_CLASSES;
import static shiver.me.timbers.TestData.TYPE_TRANSFORMATION_CLASSES;
...
public class RuleAndTokenTest {
    ...
    public void testAllTypeTransformations() throws InvocationTargetException, NoSuchMethodException,
        ...
        transformationsTest(TYPE_TRANSFORMATION_CLASSES);
    }
    ...
    public void testAllRuleTransformations() throws InvocationTargetException, NoSuchMethodException,
        ...
        transformationsTest(RULE_TRANSFORMATION_CLASSES);
    }
